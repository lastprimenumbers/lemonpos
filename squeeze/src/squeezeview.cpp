...
void squeezeView::setupLimitsModel()
{
  ...
  if (db.isOpen()) {
    ...
    limitsModel->setHeaderData(1, Qt::Horizontal, "Codice Cliente");
    limitsModel->setHeaderData(2, Qt::Horizontal, "Etichetta");
    limitsModel->setHeaderData(3, Qt::Horizontal, "Cognome");
    limitsModel->setHeaderData(4, Qt::Horizontal, "Nome");
    limitsModel->setHeaderData(5, Qt::Horizontal, "Prodotto");
    limitsModel->setHeaderData(6, Qt::Horizontal, "Categoria");
    limitsModel->setHeaderData(7, Qt::Horizontal, "Nome Prodotto");
    limitsModel->setHeaderData(8, Qt::Horizontal, "Nome Categoria");
    limitsModel->setHeaderData(9, Qt::Horizontal, "Limite");
    limitsModel->setHeaderData(10, Qt::Horizontal, "Priorità");
    limitsModel->setHeaderData(11, Qt::Horizontal, "Nome limite");
